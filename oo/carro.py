...
class Motor(object):
    ...
    def frear(self):
        self.velocidade -= 2 if self.velocidade >= 2 else 1
...
class Direcao(object):
    ...
    def __init__(self):
        self.indice = 0
        self.valor = self.DIRECOES[self.indice]

    def girar_a_direita(self):
        self.indice = self.indice + 1 if (self.indice < len(self.DIRECOES) - 1) else 0
        self.valor = self.DIRECOES[self.indice]

    def girar_a_esquerda(self):
        self.indice = self.indice - 1 if self.indice > -3 else 0
        self.valor = self.DIRECOES[self.indice]
